...
export const TextfieldRoot = simpleComponentFactory(
	'TextfieldRoot', 'label',
	{className: 'mdc-textfield'}
);

export const TextfieldLabel = simpleComponentFactory(
	'TextfieldLabel', 'span',
	{className: 'mdc-textfield__label'}
);

export const TextfieldInput = simpleComponentFactory(
...
export const TextfieldTextarea = simpleComponentFactory(
