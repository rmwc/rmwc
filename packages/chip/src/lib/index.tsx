...
export type ChipOnInteractionEventT = RMWC.CustomEventT<{
  chipId: string;
}>;
export type ChipOnTrailingIconInteractionEventT = RMWC.CustomEventT<{
  chipId: string;
}>;
export type ChipOnRemoveEventT = RMWC.CustomEventT<{
  chipId: string;
}>;
...
export interface ChipProps {
  ...
  foundationRef?: React.Ref<typeof MDCChipFoundation>;
}
...
/** A container for multiple chips. */
export const ChipSet = createComponent<ChipSetProps>(
