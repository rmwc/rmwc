...
const Typography = simpleComponentFactory('Typography', {
	...
	propMeta: {
		display4: {
			type: 'Boolean',
			desc: 'Sets typography style for display4'
		},
		display3: {
			type: 'Boolean',
			desc: 'Sets typography style for display3'
		},
		display2: {
			type: 'Boolean',
			desc: 'Sets typography style for display2'
		},
		display1: {
			type: 'Boolean',
			desc: 'Sets typography style for display1'
		},
		headline: {
			type: 'Boolean',
			desc: 'Sets typography style for headline'
		},
		title: {
			type: 'Boolean',
			desc: 'Sets typography style for title'
		},
		subheading2: {
			type: 'Boolean',
			desc: 'Sets typography style for subheading2'
		},
		subheading1: {
			type: 'Boolean',
			desc: 'Sets typography style for subheading1'
		},
		body2: {
			type: 'Boolean',
			desc: 'Sets typography style for body2'
		},
		body1: {
			type: 'Boolean',
			desc: 'Sets typography style for body1'
		},
		caption: {
			type: 'Boolean',
			desc: 'Sets typography style for caption'
		},
		button: {
			type: 'Boolean',
			desc: 'Sets typography style for button'
		}
	},
	consumeProps: [
		'display4',
