...
const RESOURCES: ResourceT[] = [
  ...
  },
  {
    ...
    description:
      'Join the conversation. Get quicker responses to questions and feedback.',
  ...
  },
  {
    ...
    description:
      'This library is built with Typescript, sweat, and thousands of hours of hard work. Help support Open Source Software!',
    ...
    actions: [
      {
        ...
        url:
          'https://github.com/jamesmfriedman/rmwc/blob/master/CONTRIBUTING.md'
      }
    ]
  }
];
...
function ResourceCard({ resource }: { resource: ResourceT }) {
  return (
    <Card className={styles.card}>
      ...
      >
        ...
        >
          <Icon icon={{ icon: resource.icon }} className={styles.icon} />
        </CardMedia>
