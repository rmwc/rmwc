...
describe('Button', () => {
  it('renders', () => {
    ...
    expect(btn.hasClass('mdc-button')).toEqual(true);
  });

  it('can be raised', () => {
    const btn = mount(<Button raised />);
    expect(btn.hasClass('mdc-button--raised')).toEqual(true);
  });

  it('can be primary', () => {
    const btn = mount(<Button primary />);
    expect(btn.hasClass('mdc-button--primary')).toEqual(true);
  });

  it('can be accent', () => {
    const btn = mount(<Button accent />);
    expect(btn.hasClass('mdc-button--accent')).toEqual(true);
  });

  it('can be dense', () => {
    const btn = mount(<Button dense />);
    expect(btn.hasClass('mdc-button--dense')).toEqual(true);
  });

  it('can be compact', () => {
    const btn = mount(<Button compact />);
    expect(btn.hasClass('mdc-button--compact')).toEqual(true);
  });
