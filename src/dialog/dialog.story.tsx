...
export const _SimpleDialog = () => <SimpleDialogStory />;

_SimpleDialog.story = {
  name: 'SimpleDialog'
};

export const PreventOutsideDismissBug = function Sandbox() {
  ...
  return (
    <React.Fragment>
      ...
      <ol>
        ...
        <li>
          Observe that the dialog is INCORRECTLY DISMISSED when using the escape
          key
        </li>
      </ol>
      <br />
