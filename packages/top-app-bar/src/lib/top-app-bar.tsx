...
export type TopAppBarNavigationIconProps = IconButtonProps;

/** A navigation icon for the top app bar. This is an instance of the IconButton component. */
export const TopAppBarNavigationIcon =
  createComponent<TopAppBarNavigationIconProps>(
...
export type TopAppBarActionItemProps = IconButtonProps;
